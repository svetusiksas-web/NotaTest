import React from 'react';import{createRoot}from'react-dom/client';import{HashRouter}from'react-router-dom';import App from './App';import{demo}from'./data/demo';import{testService}from'./services/storage';import'./styles.css';import'./enhancements.css';
...
if(!testService.all().length)testService.save(demo);
