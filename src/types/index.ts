...
export interface QuizTest {id:string;slug:string;title:string;subject:string;grade:string;topic:string;description:string;instructions:string;status:TestStatus;questions:Question[];createdAt:string;updatedAt:string}
...
export interface Attempt {id:string;testId:string;student:Student;answers:Record<string,Answer>;score:number;maxScore:number;percentage:number;grade:number;completedAt:string}
